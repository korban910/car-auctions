    ...
    private static void SeedData(AuctionDbContext context)
    {
        ...
        var auctions = new List<Auction>
        {
            ...
            new Auction
            {
                ...
                ReservePrice = 20000,
                Seller = "alice",
                AuctionEnd = DateTimeOffset.UtcNow.AddDays(30),
                Item = new Item
                {
                    Make = "BMW",
                    Model = "X1",
            ...
            new Auction
            {
                ...
                ReservePrice = 20000,
                Seller = "bob",
                AuctionEnd = DateTimeOffset.UtcNow.AddDays(45),
                Item = new Item
                {
                    Make = "Ferrari",
                    Model = "Spider",
            ...
            new Auction
            {
                ...
                ReservePrice = 150000,
                Seller = "alice",
                AuctionEnd = DateTimeOffset.UtcNow.AddDays(13),
                Item = new Item
                {
                    Make = "Ferrari",
                    Model = "F-430",
            ...
            new Auction
            {
                ...
                Status = Status.Live,
                Seller = "bob",
                AuctionEnd = DateTimeOffset.UtcNow.AddDays(19),
                Item = new Item
                {
                    Make = "Audi",
                    Model = "R8",
            ...
            new Auction
            {
                ...
                ReservePrice = 20000,
                Seller = "tom",
                AuctionEnd = DateTimeOffset.UtcNow.AddDays(20),
                Item = new Item
                {
                    Make = "Audi",
                    Model = "TT",
            ...
            new Auction
            {
                ...
                ReservePrice = 20000,
                Seller = "bob",
                AuctionEnd = DateTimeOffset.UtcNow.AddDays(48),
                Item = new Item
                {
                    Make = "Ford",
                    Model = "Model T",
